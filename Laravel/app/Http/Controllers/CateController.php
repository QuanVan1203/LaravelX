...
class CateController extends Controller {
	...
	public function getDelete($id){
		...
		if($parent==0){
			$cate = Cate::find($id);
			$cate ->delete($id);
		return redirect()->route('admin.cate.list')->with(['flash_level'=>'success','flash_message'=>'Successfully Delete']);
		} else {
			...
			return redirect()->route('admin.cate.list')->with(['flash_message_delete'=>'unsuccess','flash_message_delete'=>'Sorry! You can not delete this category!']);
	...
	public function postAdd(CateRequest $request){
		...
		$cate->save();
		return redirect()->route('admin.cate.list')->with(['flash_level'=>'success','flash_message'=>'Hello!' ]);
